...
@RequestMapping(value = "/anularAutorizacion/", method = RequestMethod.GET)
public class BandejaAnulacionAutorizAuditorController extends BaseValidatingController {
    private static Logger LOGGER = LoggerFactory.getLogger(BandejaAnulacionAutorizAuditorController.class);
    ...
    protected String gestionarItem(@PathVariable("itemId") Long id, ModelMap map) {
        ...
        try {
            ...
            vo.getBandejasParam().setEditableRedireccion(Boolean.FALSE);
            ...
            map.put("anulacionAutorizAuditor", Boolean.TRUE);
            if (tipoAuditor == SystemConstants.AUDITOR_CTC) {
                ...
                VIEW = "auditor/anulacion/anulacionItemCTC";
            } else if (tipoAuditor == SystemConstants.AUDITOR_AC) {
                ...
                VIEW = "auditor/anulacion/anulacionItemAC";
            } else if (tipoAuditor == SystemConstants.CONTACT_SERVICE) {
                HashMap<String, List<DocumentoSoporteDto>> archivos = (HashMap<String, List<DocumentoSoporteDto>>) map.get("archivos");
                ...
                VIEW = "auditor/anulacion/anulacionItemCS";
            }
            return VIEW;
        } catch (Exception e) {
            LOGGER.error("Error al consultar el detalle del item", e);
            return "anularAutorizacion/bandeja/";
        }
    }
    ...
    private int getTipoAuditor() {
        ...
        for (Role role : user.getRoles()) {
            switch (role.getRole()) {
            case SystemConstants.ROLE_AUDITOR_AC_NAC:
                return SystemConstants.AUDITOR_AC;
            case SystemConstants.ROLE_AUDITOR_CTC_REG:
                return SystemConstants.AUDITOR_CTC;
            case SystemConstants.ROLE_CONTACT_SERVICE_NAC:
                return SystemConstants.CONTACT_SERVICE;
            default:
                return -1;
            }
        }
     ...
     * solicitado
     * 
     * @param form Datos editables por el auditor en el formulario de autorización
    ...
    @ResponseBody
    public ValidatedResponse<Boolean> procesarTramite(String justificacionAnulacion, Long itemId, ModelMap map) {
        ...
        try {
            ...
            dto.setJustificacion(justificacionAnulacion);
            ...
            LOGGER.error("Error al realizar la redirección de la autorización", e);
        }
        return response;
    }
