...
/**
 * Vista auxiliar para obtención de ubicación de sedes de IPS proveedoras de medicamentos.
 * 
 * @author Sebastián Matienzo
 */
@Entity
@Table(name = "ubicacion_sede_ips_proveedor_medicamento", schema = "vista")
@Mappeable(mappedTo = UbicacionSedeIpsProveedorMedicamentoDto.class)
public class UbicacionSedeIpsProveedorMedicamento implements Identifiable<Long> {
	 ...
	 * 
	 * @param servicioId Identificador del medicamento.
	 */
	 ...
	 */
	public UbicacionSedeIpsProveedorMedicamentoDto toDto() {
		
		final UbicacionSedeIpsProveedorMedicamentoDto dto = new UbicacionSedeIpsProveedorMedicamentoDto();
		...
		dto.setMedicamentoId(this.getMedicamentoId());
