...
/**
 * Vista auxiliar para obtención de tarifas de medicamentos.
 * 
 * @author Sebastián Matienzo
 */
@Entity
@Table(name = "tarifa_medicamento_view", schema = "vista")
@Mappeable(mappedTo = TarifaProcedimientoMedicamentoInsumoDto.class)
public class TarifaMedicamentoView implements Identifiable<Long> {
	...
	/**
	 * Fecha de finalización en que aplica el medicamento contratado.
	 */
	@Column(name = "fecha_finalizacion_medicamento_contratado", nullable = false)
	private Date fechaFinalizacionMedicamentoContratado;
	...
	/**
	 * Asigna el identificador del medicamento.
	 * 
	...
	/**
	 * Obtiene la fecha de finalización del medicamento contratado.
	 * 
	 * @return Fecha de finalización del medicamento contratado.
	 */
	public Date getFechaFinalizacionMedicamentoContratado() {
		
		return (this.fechaFinalizacionMedicamentoContratado);
	}

	/**
	 * Asigna la fecha de finalización del medicamento contratado.
	 * 
	 * @param fechaFinalizacionMedicamentoContratado Fecha de finalización del medicamento contratado.
	 */
	public void setFechaFinalizacionMedicamentoContratado(final Date fechaFinalizacionMedicamentoContratado) {
		
		this.fechaFinalizacionMedicamentoContratado = fechaFinalizacionMedicamentoContratado;
	}
	...
	public TarifaProcedimientoMedicamentoInsumoDto toDto() {
		...
		dto.setItemId(this.getMedicamentoId());
		...
		dto.setFechaFinalizacionItemContratado(this.getFechaFinalizacionMedicamentoContratado());
