...
/**
 * Dto de totalización de los copagos de los afiliados (sin discriminación alguna).
 * 
 * @author Sebastián Matienzo
 */
@Mappeable(mappedTo = TotalizacionCopagoAfiliado.class)
public class TotalizacionCopagoAfiliadoDto {
