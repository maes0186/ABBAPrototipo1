...
;( function( $, doc ){
  ...
  $.msg = function(){
    ...
    configs = $.extend({
      ...
      clickUnblock : true,
      content :  '<img src="/web/resources/images/ajax-loader.gif"/>' ,
      fadeIn : 200,
      fadeOut : 300,
      bgPath : '',
    ...
    if( type === '[object String]' ){
      ...
      $overlay = $(
        '<div id="jquery-msg-overlay" class="' + configs.klass + '" style="position:absolute; z-index:' + configs.z + '; top:0px; right:0px; left:0px; height:' + $( doc ).height() + 'px;">' +
          '<img src="/web/resources/images/blank.gif" id="jquery-msg-bg" style="width: 100%; height: 100%; top: 0px; left: 0px;"/>' +
