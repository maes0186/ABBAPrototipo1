        ...
        <div class="well">
            <form class="form-horizontal" id="informacionForm">
                ...
                <blockquote class="col-lg-12 collapsible-header" style="padding: 2px; font-size: 20px;">
                    <strong> <c:if test="${bandejaAC.tipoItem == itemMedicamento}">
                            <fmt:message key='label.anulacionAutorizacionMedicamento' />
                            </c:if> 
                            <c:if test="${bandejaAC.tipoItem == itemInsumo}">
                            <fmt:message key='label.anulacionAutorizacionInsumo' />
                        </c:if> <c:if test="${bandejaAC.tipoItem == itemProcedimiento}">
                            <fmt:message key='label.anulacionAutorizacionProcedimiento' />
                        </c:if>
                    </strong>
                </blockquote>
...
<jsp:include page="./../../bandejas/includes/infoSolicitudAC.jsp" />

<%@include file="./../../bandejas/includes/auditorACJS.jsp"%>
