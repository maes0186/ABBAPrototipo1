...
<div class="row">
    <div class=" col-lg-12">
        ...
        <div class="form-horizontal">
            <form class="form-horizontal" id="formInfoSolicitudCS" method="post" enctype="multipart/form-data">
                ...
                <fieldset id="fieldSetInfoDiagnosticoCS" class="well">
                ...
                <fieldset disabled="disabled" class="well">
                    <div id="contentItemSolicitado" class="tab-content">
                        <c:if test="${bandejaCS.tipoItem == itemMedicamento}">
                            <jsp:include page="./infoMedicamentoCS.jsp" />
                        </c:if>

                        <c:if test="${bandejaCS.tipoItem == itemProcedimiento}">
                            <jsp:include page="./infoProcedimientoCS.jsp" />
                        </c:if>
                        
                         <c:if test="${bandejaCS.tipoItem == itemInsumo}">
                            <jsp:include page="./infoInsumoCS.jsp" />
                        </c:if>
                        <br />
                    </div>
                </fieldset>
                ...
                <fieldset class="well">
                    ...
                    <div class="collapsible-content" style="padding-left: 20px;">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-lg-6">
                                <jsp:include page="./docSoporte.jsp">
                                    <jsp:param value="archivosCS" name="tipoArchivo" />
                        ...
                        <div class="form-group form-group-sm">
                            <c:if test="${bandejaCS.devueltaLF}">
                            ...
                            <div class="col-lg-6">
                                <c:if test="${bandejaCS.devueltaLF}">
                                    <textarea class="form-control input-sm" rows="3" id="observacionesLF" name="observacionesLF"
                                        disabled="disabled">${bandejaCS.observacionesLineaFrente}</textarea>
                                </c:if>
                            </div>
                        </div>
                    </div>
                </fieldset>
                <jsp:include page="./infoDevolucionesCS.jsp">
                    <jsp:param value="${bandejasParam.caseDevoluciones}" name="casoDevolucion" />
                </jsp:include>
                <jsp:include page="./conceptoCS.jsp">
                    <jsp:param value="${disabledInput}" name="disableInput" />
                    <jsp:param value="${bandejasParam.caseDevoluciones}" name="casoDevolucion" />
                </jsp:include>
