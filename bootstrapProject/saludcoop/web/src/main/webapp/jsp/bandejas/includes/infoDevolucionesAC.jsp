        ...
        <fieldset disabled="disabled" class="well">
            ...
            <div class="collapsible-content" style="padding-left: 20px;">
                        ...
                        <c:if test="${infoDevoluciones.concepto == 1}">
                            ...
                            <div id="contentItemSolicitado" class="tab-content">
                                ...
                                <c:if test="${bandejaAC.tipoItem == itemMedicamento}">
                                    <div class="form-group form-group-sm">
                                        <label for="cantidadAprobadaACDev" class="control-label control-label-sm col-lg-3"
                                            style="text-align: left;">${PERIODO_LABEL}</label>
                                        <div class="col-lg-2">
                                            <input class="form-control input-sm" id="periodoAprobadoACDev" name="devperiodoAprobado"
                                                placeholder="${PERIODO_LABEL}" maxlength="4" value="${infoDevoluciones.periodoAprobado}" />
                                        </div>
                                        <label for="diasPeriodoACDev" class="control-label control-label-sm col-lg-2">${DIAS_PER_LABEL}</label>
                                        <div class="col-lg-2">
                                            <input class="form-control input-sm" id="diasPeriodoACDev" name="devdiasPeriodo"
                                                placeholder="${DIAS_PER_LABEL}" maxlength="4" value="${infoDevoluciones.diasPeriodo}" />
                                        </div>
                                    </div>
                                    <div class="form-group form-group-sm">
                                        <label for="unidadesAprobadasACDev" class="control-label control-label-sm col-lg-3"
                                            style="text-align: left;">${UNID_APR_PER_LABEL}</label>
                                        <div class="col-lg-2">
                                            <input class="form-control input-sm" id="unidadesAprobadasACDev" name="devunidadesAprobadas"
                                                placeholder="${UNID_APR_PER_LABEL}" maxlength="4"
                                                value="${infoDevoluciones.unidadesAprobadas}" />
                                        </div>
                                        <label for="dosisAprobadaACDev" class="control-label control-label-sm col-lg-2">${DOSIS_APR_LABEL}</label>
                                        <div class="col-lg-2">
                                            <input class="form-control input-sm" id="dosisAprobadaACDev" name="devdosisAprobada"
                                                placeholder="${DOSIS_APR_LABEL}" value="${infoDevoluciones.dosisAprobada}" />
                                        </div>
                                    </div>
                                    <div class="form-group form-group-sm">
                                        <label for="numeroEntregasACDev" class="control-label control-label-sm col-lg-3"
                                            style="padding-right: 0px; text-align: left;">${NUM_ENTREGAS_LABEL}</label>
                                        <div class="col-lg-2">
                                            <input class="form-control input-sm" id="numeroEntregasACDev" name="devnumeroEntregas"
                                ...
                                <c:if test="${bandejaAC.tipoItem == itemProcedimiento}">
                                    <div class="form-group form-group-sm">
                                        <label for="unidadesAprobadasACDev" class="control-label control-label-sm col-lg-2"
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-lg-12">
                        <textarea name="devjustificacion" id="justificacionACDev" class="form-control input-sm"
                    ...
                    ${infoDevoluciones.justificacion}
                        ...
                        <script type="text/javascript">
                            $("#justificacionACDev").val($.trim($("#justificacionACDev").val()));
                        </script>
                    </div>
                </div>
                <br />
