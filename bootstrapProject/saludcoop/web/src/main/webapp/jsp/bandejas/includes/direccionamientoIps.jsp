    ...
    <div class="collapsible-content">
        ...
        <div class="form-group form-group-sm" style="padding-left: 20px;">
            ...
            <c:if test="${param.editable}">
                <div class="col-lg-1">
                    <button type="button" class="btn btn-link btn-sm" data-toggle="modal" href="#dirIps" id="btnLoadIps">
...
<script type="text/javascript" src="${webContext}/resources/js/auditor/funTablaDireccionamiento.js"></script>
