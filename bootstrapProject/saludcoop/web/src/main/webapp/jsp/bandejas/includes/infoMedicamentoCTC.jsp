    ...
    <div class="collapsible-content">
        <c:if test="${infoMedicamento.sinAlternativaPOSPrev}">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <textarea class="form-control" id="justifNOexisteAlternPOSPrev" disabled="disabled">${infoMedicamento.justificacionSinPOSPrev}</textarea>
                </div>
            </div>
        </c:if>
        <c:if test="${!infoMedicamento.sinAlternativaPOSPrev}">
            <p>
                <fmt:message key="label.medicamento.posPreviosUtilizados" />
            </p>
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <c:forEach items="${infoMedicamento.medicamentosAnteriores}" var="medicamentosPrevios">
                        <tr>
                            <td><c:out value="${medicamentosPrevios.medicamento.codigo}" /></td>
                            <td><c:out value="${medicamentosPrevios.medicamento.descripcion}" /></td>
                            <td><c:out value="${medicamentosPrevios.dosis}" /></td>
                            <td><c:out value="${medicamentosPrevios.diasTratamiento}" /></td>
                            <td><c:out value="${medicamentosPrevios.respuestaClinicaObservada.descripcion}" /></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
...
<fieldset disabled="disabled" class="well">
    ...
    <div class="collapsible-content">
        <div class="form-group form-group-sm">
            ...
            </label> <label class="col-lg-1 control-label control-label-sm text-info" style="text-align: left;">${infoMedicamento.riesgoInminente}</label>
        </div>
        <c:if test="${infoMedicamento.riesgoInminente == respSI}">
            <div class="form-group form-group-sm">
                ...
                <div class="col-lg-9">
                    <textarea name="justificRiesgoTextArea" id="justificRiesgoTextArea" class="form-control">${infoMedicamento.justificacionRiesgo}</textarea>
                </div>
            </div>
        </c:if>
        <div class="form-group form-group-sm">
            ...
            </label> <label class="col-lg-1 control-label control-label-sm text-info" style="text-align: left;">${infoMedicamento.posibilidadesAgotadas}</label>
        </div>
        <div class="form-group form-group-sm">
            ...
            </label> <label class="col-lg-2 control-label control-label-sm text-info" style="text-align: left;">${infoMedicamento.autorizacionINVIMA}</label>
        </div>
        <div class="form-group form-group-sm">
            ...
            <div class="col-lg-9">
                <textarea name="justificMedico" id="justificMedico" class="form-control">${infoMedicamento.justificacionMedico}</textarea>
            </div>
        </div>
    </div>
</fieldset>