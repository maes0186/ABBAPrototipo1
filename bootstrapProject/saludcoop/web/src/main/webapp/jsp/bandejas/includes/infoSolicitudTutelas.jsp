...
<div class="row">
    <div class=" col-lg-12">
        ...
        <div class="form-horizontal">
            <form class="form-horizontal" id="formInfoSolicitudTutelas" method="post" enctype="multipart/form-data">
                <input type="hidden" value="${itemId}" id="itemId" name="itemId" />
                <c:if test="${!esLDF}">
                    <jsp:include page="./infoTutelas.jsp">
                ...
                <fieldset id="fieldSetInfoDiagnosticoTutelas" class="well">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-lg-6">
                                <jsp:include page="./docSoporte.jsp">
                                    <jsp:param value="archivosTutelas" name="tipoArchivo" />
                            ...
                            <div class="col-lg-6">
                                <c:if test="${!esLDF}">
                                    <textarea class="form-control input-sm" rows="3" id="observacionesLF" name="observacionesLF"
                                        disabled="disabled">${conceptoTutelas.justificacionLdf}</textarea>
                                    <br />
                                </c:if>
                            </div>
                        </div>
                ...
                <jsp:include page="./infoDevolucionesTutelas.jsp">
                    <jsp:param value="${bandejasParam.caseDevoluciones}" name="casoDevolucion" />
                </jsp:include>
                <jsp:include page="./conceptoTutelas.jsp">
                    <jsp:param value="${disabledInput}" name="disableInput" />
                </jsp:include>
