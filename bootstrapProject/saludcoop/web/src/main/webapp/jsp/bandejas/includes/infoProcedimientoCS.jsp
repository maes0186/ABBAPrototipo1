    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-lg-2">
            <input class="form-control input-sm" id="codigoProcedimiento" name="codigoProcedimiento" placeholder="${CODIGO_CUPS}"
                value="${bandejaCS.procedimiento.codigo}" />
        </div>
    </div>
    ...
    <div class="form-group form-group-sm">
        ...
        <div class="col-lg-9">
            <input class="form-control input-sm" id="nombreProcedimiento" name="nombreProcedimiento" placeholder="${NOMBRE}"
                value="${bandejaCS.procedimiento.nombre}" />
        </div>
    </div>
    <div class="form-group form-group-sm">
        ...
        <div class="col-lg-2">
            <input class="form-control input-sm" id="cantidadSolicitada" name="cantidadSolicitada" placeholder="${CANT_SOL_LABEL}"
                maxlength="4" value="${bandejaCS.procedimiento.cantidadSolicitada}" />
        </div>
        <label for="lateralidadCS" class="control-label control-label-sm text-right col-lg-3">${LATERALIDAD_LABEL}</label>
        <div class="col-lg-2">
            <input class="form-control input-sm" id="lateralidadProcCS" name="lateralidadProcCS" placeholder="${LATERALIDAD_LABEL}"
                value="${bandejaCS.procedimiento.lateralidad}" />
        </div>
    </div>
    <br />
</div>