...
/**
 * <b>Bandeja de tutelas</b> <br />
 * Clase encargada de controlar las peticiones desde la bandeja de tutelas tanto de línea de frente como 
 * auditor
 * 
 ...
 */
@Controller
@SessionAttributes({ "idSolicitudItem", "esLDF", "msgRespuesta" })
@RequestMapping(value = "/bandejaTutelas/")
public class BandejaTutelasController extends BaseValidatingController {
    ...
    protected String gestionarItem(@PathVariable("itemId") Long id, ModelMap map) {
        try {
            ...
            int tipoUsuario = SystemConstants.AUDITOR_TUTELAS;
            if((boolean)map.get("esLDF")) {
                tipoUsuario = SystemConstants.LINEA_FRENTE;
            }
            
            vo.getBandejasParam().setTipoBandeja(tipoBandeja);
            BandejasController.validarCaseDevolucion(vo.getBandejasParam(), SystemConstants.AUDITOR_TUTELAS);
            BandejasController.validarMostrarOpciones(vo.getBandejasParam(), tipoUsuario);
            ...
            map.put("conceptoTutelas", vo.getConceptoACVO());
            map.put("infoDevoluciones", vo.getInfoDevoluciones());

            return "auditor/gestionarItemTutelas";
        } catch (Exception e) {
            LOGGER.error("Error al consultar el detalle del item", e);
            return "auditor/bandejaTutelas";
        }
    }
    ...
    public ValidatedResponse<Boolean> procesarTramite(BandejasForm form, ModelMap map) {
        ...
        try {
            ...
            dto.setEsLdf((boolean)map.get("esLDF"));
            ...
            RespuestaDto respuesta = validatorServiceManager.gestionarItemTutela(dto);
