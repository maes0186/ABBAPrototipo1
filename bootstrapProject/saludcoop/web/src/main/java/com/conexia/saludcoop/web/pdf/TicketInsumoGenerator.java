...
public class TicketInsumoGenerator {
	...
	public static void crearPDF(Document document, TicketCabeceraDto ticket, boolean esReimpresion, URL urlCabecera) throws DocumentException, IOException {
		...
		TicketInsumoGenerator.addEncabezado(document, ticket, esReimpresion, urlCabecera);
		TicketInsumoGenerator.addDatosSolicitud(document, ticket);
		TicketInsumoGenerator.addPracticas(document, ticket);
		TicketInsumoGenerator.addTipoPago(document, ticket);
		TicketInsumoGenerator.addPie(document, ticket);
