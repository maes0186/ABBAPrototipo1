...
function createComponent(field, context) {
	...
	case 'combo-sync':
		...
		return combo;
	case 'modalCaller':
		console.log(field.modalId);
		var $button = $("<a data-toggle='modal' style='color:white' href='#"+field.modalId+"' title='"+field.description+"'><button onclick='setFormTargetContainer($(this));eval(\"fill"+field.modalId+"($(this))\")' class='btn btn-sm btn-warning' rel='tooltip' type='button' ><i class='icon-edit'></i></button></a>");
