...
/**
 * Funcion de nombre reducido para insertar textos i18n en los archivos js
 * 
 * @param param Es la clave para buscar el texto
 * @returns
 */
function i18n(param){
	var txt =  $.i18n.prop(param);
	if(txt == "["+param+"]")
		log("No encontrado "+param);
 ...
 * 
 * @param param Es la clave para buscar el texto
 * @param stringMode {1: convierte a minusculas, 2: convierte a mayusculas, 3: capitaliza}
 * @returns
 */
function i18n(param, stringMode){
	var txt =  $.i18n.prop(param);
	if(txt == "["+param+"]")
		log("No encontrado "+param);
	else{
