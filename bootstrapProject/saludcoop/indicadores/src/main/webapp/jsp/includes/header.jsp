...
<html lang="es">
	<head>
		...
		<link rel="stylesheet" href="${webContext}/resources/css/bandeja.css" >
		...
		<script src="${webContext}/resources/js/jquery/jquery-1.10.2.min.js"></script> 
	...
	<body style="padding-top: 0px;">
		<!-- HEADER -->
		<div class="navbar-static-top" style="background:url(${webContext}/resources/images/bg.jpg) no-repeat; background-color:white">
			<div class="container">
