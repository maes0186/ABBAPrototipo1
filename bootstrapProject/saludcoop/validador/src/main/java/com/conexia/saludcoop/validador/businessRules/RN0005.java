...
@Component
@Rule(description = "Verificar y marcar afiliado con complicaciones de Hemofilia.")
public class RN0005 extends RNProcess {

	private static Logger LOGGER = LoggerFactory.getLogger(RN0005.class);
