...
/**
 * Redirecciona un procedimiento por IPS dentro de la SECCIONAL del municipio de residencia del afiliado.
 * 
 * @author Emmanuel Barbín
 * @author Sebastián Matienzo
 */
@Component
public class RedireccionProcedimientoPorSeccional implements IEstrategiaRedireccionProcedimiento {
	...
	public List<UbicacionSedeIpsEfectorProcedimiento> getUbicacionesConformeEstrategia(
		...
		return (this.repository.getSedesIpsPorDivisionSeccional(epsId, procedimientoId, codigoTipoMinuta, 
												idSedeIpsExcluir, divisionesSeccionalesId, debeOrdenarPorValorAjustado, numeroPagina));
	}
}
