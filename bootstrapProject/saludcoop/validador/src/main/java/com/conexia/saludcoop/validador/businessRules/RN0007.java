...
@Component
@Rule(description = "Verificar si existen autorizaciones previas.")
public class RN0007 extends RNProcess {

	private static Logger LOGGER = LoggerFactory.getLogger(RN0007.class);
