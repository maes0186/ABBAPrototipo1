...
/**
 * Redirecciona un procedimiento por IPS dentro del MUNICIPIO de residencia del afiliado.
 * 
 * @author Emmanuel Barbín
 * @author Sebastián Matienzo
 */
@Component
public class RedireccionProcedimientoPorMunicipio implements IEstrategiaRedireccionProcedimiento {
	...
	public List<UbicacionSedeIpsEfectorProcedimiento> getUbicacionesConformeEstrategia(
		...
		return (this.repository.getSedesIpsPorMunicipio(epsId, procedimientoId, codigoTipoMinuta, 
															idSedeIpsExcluir, idMunicipio, debeOrdenarPorValorAjustado, numeroPagina));
	}
}
