...
public class Beans implements Serializable {
	...
	public Nodo getAllMapping() throws MalformedURLException, SAXException,
			IOException {
		if (allMapping == null)
			allMapping = getXMLNode();
		return allMapping;
	}
	...
	private Nodo getXMLNode() throws MalformedURLException, SAXException,
			IOException {
